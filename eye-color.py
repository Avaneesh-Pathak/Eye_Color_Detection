...
parser.add_argument('--input_path', default='sample/video.mp4', help="it can be image or video or webcan id")
parser.add_argument('--input_type', default='video', help= "either image or video (for video file and webcam id)")
